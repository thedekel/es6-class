...
var visitors = {
  visitClassDeclaration: visitNode,
  visitClassExpression: visitNode,
  visitCallExpression: visitNode,
  visitMemberExpression: visitNode
};
...
function visitClassExpression(nodePath) {
  var node = nodePath.value;
  nodePath.replace(generateClassDefinitionExpression.call(this, node));
  this.traverse();
}
...
module.exports.compile = recast.genCompile(transform);
module.exports.parse = recast.genParse(transform);
module.exports.transform = transform;
module.exports.nodeVisitors = {
  visitNode: visitNode,
